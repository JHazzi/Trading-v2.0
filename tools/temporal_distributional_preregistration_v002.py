...
if __package__:
    from .temporal_dataset_v002 import file_digest, file_state, ro_connect
...
DEFAULT_CONFIG = ROOT / "config" / "temporal_distributional_preregistration_v002.json"
DEFAULT_REPORT_DIR = ROOT / "reports" / "temporal_distributional_v002"
...
def load_contract(path: Path) -> dict[str, Any]:
    ...
    if payload.get("version") != "market_temporal_distributional_preregistration_v002":
...
def _fold_plan(
    ...
    return {
        "version": "market_temporal_distributional_outer_fold_plan_v002",
...
def build_plan(
    ...
    audit = {
        "version": "market_temporal_distributional_preregistration_audit_v002",
